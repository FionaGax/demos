...
<div class="form-container">
    <form id="readonlyCar" class="form" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
        <h1>Found Car</h1>
        ...
        <div class="form-field">
            ...
            <input type="text" name="vin" id="vin" autocomplete="off" placeholder="12KsnKSLEvmsnkx319" required minlength="17" maxlength="17" value="<?php if($vin !== "") {echo $vin;}?>">
            <small><?php if($vinErrorMessage !== "") {echo $vinErrorMessage; } ?></small>
        </div>
